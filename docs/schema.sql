...
-- Auto-cria user row após signup
...
begin
  ...
  values (new.id, v_tenant_id, new.raw_user_meta_data->>'name', 'owner', true);
...
create table supplier_orders (
  ...
  notes               text,
  status              text default 'requested',  -- requested | delivered | cancelled
  created_at          timestamptz default now()
);
